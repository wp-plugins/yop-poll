<?php
    ...
    class Yop_Poll_Model {
        ...
        public static function save_poll( $preview = false ) {
            ...
            $new_poll->poll_end_date    = ( isset( $_POST['poll_never_expire'] ) && 'yes' == $_POST['poll_never_expire'] ) ? '18-01-2038 23:59:59' : $_POST['poll_end_date'];
        ...
        public static function get_bans_filter_search(
			...
			IFNULL( " . $wpdb->yop_polls . ".poll_title, '" . __( 'All Yop Polls', 'yop_poll' ) . "' ) as name
