...
abstract class YOP_POLL_Abstract_Model {
    ...
    function __construct( $id = 0, $is_view_results = "no", $question_sort = "poll_order", $question_sort_rule = "ASC", $answer_sort = "question_order", $answer_sort_rule = "ASC" ) {
        ...
        $this->poll_start_date = convert_date( $this->poll_start_date, "d-m-Y H:i:s" );

        $this->poll_end_date   = convert_date( $this->poll_end_date, "d-m-Y H:i:s" );
    ...
    function insert() {
        if($this->poll_end_date=="18-01-2038 23:59:59")
        ...
        $GLOBALS['wpdb']->query( $GLOBALS['wpdb']->prepare( "
					...
					poll_total_votes	= %d
						...
						", $this->poll_title, $this->poll_name, $this->poll_author, $this->poll_date, $this->poll_status, $this->poll_modified, $this->type, convert_date( $this->poll_start_date, 'Y-m-d H:i:s' ), convert_date( $this->poll_end_date, 'Y-m-d H:i:s',1 ), $this->poll_total_votes ) );
    ...
    function update() {
        ...
        $GLOBALS['wpdb']->query( $GLOBALS['wpdb']->prepare( "
					...
					", $this->poll_title, $this->poll_name, $this->poll_status, $this->poll_modified, convert_date( $this->poll_start_date, 'Y-m-d H:i:s' ,1), convert_date( $this->poll_end_date, 'Y-m-d H:i:s',1 ), $this->id ) );
    ...
    protected function sendMail( $mail_notifications_answers, $mail_notifications_custom_fields, $vote_id ) {
        ...
        $body = str_replace( '%VOTE_DATE%', self::convert_date( current_time( 'mysql' ), $this->date_format ), $body );
