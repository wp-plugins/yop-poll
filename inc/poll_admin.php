    ...
    class YOP_POLL_Poll_Admin extends YOP_POLL_Abstract_Admin {
        ...
        private function view_polls() {
           ...
           // wp_enqueue_style( 'yop-poll-admin-css', YOP_POLL_URL . 'css/yop-poll-admin.css', array(), YOP_POLL_VERSION );
            ...
            if ( $optin_box_modal_options['show'] == 'yes' ){
                wp_enqueue_script( 'yop-poll-modal-box-js', YOP_POLL_URL."modal/js/jquery.modalbox-1.5.0-min.js", array( 'jquery' ), $this->_config->version, true );
          ...
          /*  wp_enqueue_script( 'yop-poll-modal-box-js', YOP_POLL_URL."js/jquery.modalbox-1.5.0-min.js", array( 'jquery' ), $this->_config->version, true );
            ...
            $orderby  = ( empty ( $GLOBALS['orderby'] ) ) ? 'poll_name' : $GLOBALS['orderby'];
        ...
        private function view_add_edit( $action_type = 'add' ) {
            ...
            $yop_poll_add_new_config = array(
                ...
                'text_remove_answer'              => __yop_poll( 'Remove' ),
                'text_remove_customfield'         => __yop_poll( 'Remove' ),
        ...
        public function get_poll_id_by_start_date_end_date( $start_date = "2014-02-03", $end_date = "18-01-2038 23:59:59" ) {
            $start_date .= " 00:00:00";
            $end_date .= " 23:59:59";
            global $wpdb;
        ...
        */
        ...
        private function delete_results() {
            ...
            if( check_admin_referer( 'yop-poll-results_vote', 'yop-poll-results_votes' ) ) {
                ...
                else if( isset( $_REQUEST['resultid'] ) ) {
