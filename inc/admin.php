<?php
    ...
    class Yop_Poll_Admin extends Yop_Poll_Plugin {
        ...
        ?>
            <style type="text/css">
                ...
                @font-face {
                    ...
                    src: url('<?php echo $this->_config->plugin_url; ?>/cssfonts/fontomas-webfont.eot');
        ...
        protected function init() {
            global $maintenance;
            $this->add_filter( 'http_request_args', 'disable_check_for_updates_wp', 10, 2 );
