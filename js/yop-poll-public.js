...
function yop_poll_register_vote( poll_id ) {
	...
	yop_poll_various_config.vote_loading_image_target	= 'yop_poll_vote-button-'+ poll_id;
	yop_poll_various_config.vote_loading_image_id		= 'yop_poll_vote_button_loading_img-'+ poll_id;
...
function yop_poll_vote_with_facebook( yop_poll_various_config ) {
	...
	jQuery('#yop_poll_vote-button-' + yop_poll_various_config.poll_id ).popupWindow({
...
function yop_poll_do_vote( yop_poll_various_config, location ) { 
	poll_id  			= typeof yop_poll_various_config.poll_id  !== 'undefined' ? yop_poll_various_config.poll_id  : 0;
	...
	jQuery.ajax({
		type: 'POST',
		url: yop_poll_public_config_general.ajax.url,
		data: 'action=' + yop_poll_public_config_general.ajax.vote_action + '&poll_id=' + poll_id + '&' + jQuery('#yop-poll-form-'+ poll_id).serialize() + '&vote_type=' + vote_type + '&facebook_user_details=' + yop_poll_various_config.facebook_user_details+ '&facebook_error=' + yop_poll_various_config.facebook_error,
		cache: false,
		async: false
	}).done( function( data ) {
...
function yop_poll_reloadCaptcha( poll_id ) {
	var yop_poll_public_config	= window['yop_poll_public_config_' +poll_id ];
	jQuery('#yop_poll_captcha_image_' + poll_id).attr( 'src', yop_poll_public_config_general.ajax.url + '?action=' + yop_poll_public_config_general.ajax.captcha_action + '&poll_id=' + poll_id + '&sid=' + Math.random() );
}
...
function yop_poll_show_multiple_vote_options( yop_poll_various_config ) {
	...
	var vote_options_string	= '<div id="yop_poll_vote_options_div-' + yop_poll_various_config.poll_id + '">';
	if ( vote_options.W )
		vote_options_string += '<button class="yop_poll_wordpress_vote_button" id="yop_poll_wordpress-vote-button-' + yop_poll_various_config.poll_id + '" onclick="yop_poll_vote_on_multiple_options(\'' + yop_poll_various_config.poll_id + '\',\'wordpress\'); return false;">' + yop_poll_various_config.public_config.poll_options.vote_permisions_wordpress_label + '</button><br>';
	if ( vote_options.F )
		vote_options_string += '<button class="yop_poll_facebook_vote_button" id="yop_poll_facebook-vote-button-' + yop_poll_various_config.poll_id + '" onclick="yop_poll_vote_on_multiple_options(\'' + yop_poll_various_config.poll_id + '\',\'facebook\'); return false;">' + yop_poll_various_config.public_config.poll_options.vote_permisions_facebook_label + '</button><br>';
	if ( vote_options.A )
		vote_options_string += '<button class="yop_poll_anonymous_vote_button" id="yop_poll_anonimous-vote-button-' + yop_poll_various_config.poll_id + '" onclick="yop_poll_vote_on_multiple_options(\'' + yop_poll_various_config.poll_id + '\',\'anonymous\'); return false;">' + yop_poll_various_config.public_config.poll_options.vote_permisions_anonymous_label + '</button><br>';
...
function yop_poll_vote_on_multiple_options( poll_id, vote_type ) {
	var yop_poll_public_config							= window['yop_poll_public_config_' + poll_id ];
	var yop_poll_various_config 						= new Object();
	yop_poll_various_config.poll_id						= poll_id;
	yop_poll_various_config.is_modal					= 0;
	yop_poll_various_config.vote_loading_image_target	= 'yop_poll_vote_options_div-'+ poll_id;
	yop_poll_various_config.vote_loading_image_id		= 'yop_poll_vote_button_loading_img-'+ poll_id;
	yop_poll_various_config.vote_loading_image_alt		= yop_poll_public_config.loading_image_alt;
